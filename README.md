...
| `@maayo/spring` | [![GitHub Packages](https://img.shields.io/badge/GitHub%20Packages-0.3.2-blue?style=flat-square)](https://github.com/elroykanye/maayo/packages) | — | Spring Boot autoconfiguration |
...
dependencies {
    implementation("dev.maayo:maayo-spring:0.3.2")
}
```
